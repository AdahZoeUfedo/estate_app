import { ImageSourcePropType, TouchableOpacity, Image, View, Text, SafeAreaView,ScrollView, Alert } from 'react-native'
...
const SettingsItem = ({ icon, title, onPress, textStyle, showArrow
  =true}: SettingsItemProps) => (
